...
module i2c_master(input clk,rst,newd,
  ...
  typedef enum logic [3:0] {idle=0,start=1,write_addr=2,ack_1=3,write_data=4,read_data=5,stop=6,ack_2=7,master_ack=8}
  state_type;
            ...
            ack_1:
              begin
                ...
                case(pulse)
                  ...
                  2:begin scl_t<=1'b0;sda_t<=1'b0;r_ack<=sda;end
  ...
  assign sda=(sda_t===1)?(sda_t==0)?1'b0:1'b1:1'bz;
  assign scl=scl_t;
  assign dout=rx_data;
endmodule
